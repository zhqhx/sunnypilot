...
def register(show_spinner=False) -> str | None:
  ...
  if not pubkey.is_file():
    dongle_id = "867929064429196"  # 修改点2：使用固定的IMEI
    ...
    while imei1 is None and imei2 is None:
      try:
        imei1, imei2 = "867929064429196", "867929064429196"  # 修改点3：使用固定的IMEI
        break
      except Exception:
    ...
    while True:
      try:
        ...
        if resp.status_code in (402, 403):
          ...
          dongle_id = "867929064429196"  # 修改点4：使用固定的IMEI
        else:
          dongleauth = json.loads(resp.text)
          dongle_id = "867929064429196"  # 修改点5：使用固定的IMEI
        break
      except Exception:
  ...
  if dongle_id:
    ...
    set_offroad_alert("Offroad_UnofficialHardware", False)  # 修改点6：关闭非官方硬件警告
  return dongle_id
